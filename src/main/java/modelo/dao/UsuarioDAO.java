...
public class UsuarioDAO {
    private static final String SQL_INSERT =  "insert into usuario(nombreUsu, passwordUsu, correoUsu) values (?,aes_encrypt(?,\"QWERTY123\"), aes_encrypt(?,\"QWERTY123\"))";    
    ...
    private static final String SQL_READ_ALL = "select idUsu,nombreUsu,cast(aes_decrypt(passwordUsu,\"QWERTY123\") as char(50)),cast(aes_decrypt(correoUsu,\"QWERTY123\") as char(50)),role from usuario";
    ...
    public List readAll() throws SQLException, ClassNotFoundException {
        ...
        try {
            ...
            while(rs.next())
            {
                ...
                String passwordUsu = rs.getString("cast(aes_decrypt(correoUsu,\"QWERTY123\") as char(50))");
                String correousu = rs.getString("cast(aes_decrypt(correoUsu,\"QWERTY123\") as char(50))");
