 ...
 * @author Sebastián
 */
@WebServlet(name = "MostrarEstado", urlPatterns = {"/MostrarEstado"})
public class MostrarEstado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MostrarEstado</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            out.println("<h1>Servlet MostrarEstado at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
