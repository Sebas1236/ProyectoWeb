 ...
 * @author Sebastián
 */
@WebServlet(name = "AlmacenarActualizacionUsuario", urlPatterns = {"/AlmacenarActualizacionUsuario"})
public class AlmacenarActualizacionUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AlmacenarActualizacionUsuario</title>");            
            out.println("</head>");
            out.println("<body>");
