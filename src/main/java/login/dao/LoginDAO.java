...
private static final String SQL_LOGIN= "select nombreUsu,cast(aes_decrypt(passwordUsu,\"QWERTY123\") AS char(50)),cast(aes_decrypt(correoUsu,\"QWERTY123\") AS char(50)),role from usuario";
...
public String authenticateUser(LoginBean loginBean) throws SQLException, ClassNotFoundException
{
 ...
 try
 {
  ...
  while(rs.next())
  {
   ...
   passwordBD = rs.getString("cast(aes_decrypt(passwordUsu,\"QWERTY123\") AS char(50))");
   rolBD = rs.getString("role");
   correoBD = rs.getString("cast(aes_decrypt(correoUsu,\"QWERTY123\") AS char(50))");
